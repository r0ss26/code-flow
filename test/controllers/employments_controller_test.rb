...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post employments_url, params: { employment: { company: @employment.company, end_date: @employment.end_date, position: @employment.position, start_date: @employment.start_date } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { company: @employment.company, end_date: @employment.end_date, position: @employment.position, start_date: @employment.start_date } }
